...
<span>Brand Name : </span><input type="text" name="bname" class = "form-control" value="<?php echo $row['product_name']; ?>" readonly/>
<span>Description Name : </span><input type="text" name="dname" class = "form-control" value="<?php echo $row['description_name']; ?>" readonly/>
...
<span>Category: </span><input type="text" name="categ" class = "form-control" value="<?php echo $row['category']; ?>" readonly/>
