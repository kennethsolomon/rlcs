                    ...
                    <tbody>
                        ...
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
                                ...
                                <td>
                                <form method="get" action="employee_salary_chart.php">
                                    ...
                                    <label><input name="id" id="id" type="hidden" value="<?php echo $row['customer_name']; ?>" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                                    <label><button class="form-control" type="submitBtn" name="submitBtn" >View</button></label>
                                    <!-- <a class="form-control" type="submitdate" name="submitdate" href=""> 
                                    <i class = "fa fa-eye"></i> -->
                                </a>
                                </form>
                                <?php
