...
<br>
<p style="font-size: 10px; "><b>	Prepared by: ________________________
<span style="font-size: 10px;margin-left:30px"> Approved by: ________________________
<span style="font-size: 10px;margin-left:30px"> Received by: ________________________
...
<a href = "account_payable.php" class="btn btn-primary btn-m " >
  Back    
</a>
</div>
